...
{
    public Rectangles(string outputDir) : base(outputDir) { }

    public void Rect_Stroke_1px() => Render(100, 100, g => {
    ...
    public void Rect_Stroke_3px() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Rect_Fill_Red() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Rect_Fill_Small() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Rect_StrokeAndFill() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
        using var brush = new SolidBrush(Color.Red);
        g.FillRectangle(brush, 10, 10, 80, 80);
    ...
    public void Rect_Multiple() => Render(200, 200, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
