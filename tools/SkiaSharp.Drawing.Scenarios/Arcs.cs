...
{
    public Arcs(string outputDir) : base(outputDir) { }

    public void Arc_Quarter() => Render(100, 100, g => {
    ...
    public void Arc_Half() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Arc_ThreeQuarter() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Arc_NegativeStart() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    public void Arc_Thick() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
