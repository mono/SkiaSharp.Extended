...
/// <see cref="SKDeepZoomTileLayout"/> and passed into the draw methods.
/// </para>
/// </remarks>
public interface ISKDeepZoomRenderer : IDisposable
{
    /// <summary>
    ...
    void DrawTile(SKDeepZoomRectF destRect, ISKDeepZoomTile tile);
    ...
    void DrawFallbackTile(SKDeepZoomRectF destRect, SKDeepZoomRectF sourceRect, ISKDeepZoomTile tile);
