...
/// </summary>
public readonly struct SKImagePyramidDisplayRect : IEquatable<SKImagePyramidDisplayRect>
{
    ...
    public SKImagePyramidDisplayRect(int x, int y, int width, int height, int minLevel, int maxLevel)
    {
        X = x;
        Y = y;
        Width = width;
    ...
    public bool Equals(SKImagePyramidDisplayRect other) =>
        X == other.X && Y == other.Y && Width == other.Width && Height == other.Height &&
        MinLevel == other.MinLevel && MaxLevel == other.MaxLevel;

    public override bool Equals(object? obj) => obj is SKImagePyramidDisplayRect other && Equals(other);
    ...
    public static bool operator ==(SKImagePyramidDisplayRect left, SKImagePyramidDisplayRect right) => left.Equals(right);
    public static bool operator !=(SKImagePyramidDisplayRect left, SKImagePyramidDisplayRect right) => !left.Equals(right);

    public override string ToString() =>
        $"SKImagePyramidDisplayRect({X}, {Y}, {Width}x{Height}, Levels {MinLevel}-{MaxLevel})";
}
