...
public class SKImagePyramidDziCollectionSource
{
    ...
    private readonly List<SKImagePyramidDziCollectionSubImage> _items;
    ...
    public SKImagePyramidDziCollectionSource(int maxLevel, int tileSize, string format, IReadOnlyList<SKImagePyramidDziCollectionSubImage> items)
    {
        ...
        TileSize = tileSize;
        Format = format;
        _items = new List<SKImagePyramidDziCollectionSubImage>(items);
    }
    ...
    public IReadOnlyList<SKImagePyramidDziCollectionSubImage> Items => _items;
    ...
    private static SKImagePyramidDziCollectionSource ParseDocument(XDocument doc, string? baseUri)
    {
        ...
        if (itemsElement != null)
        {
            foreach (var iElement in itemsElement.Elements(ns + "I"))
            {
                ...
                var subImage = new SKImagePyramidDziCollectionSubImage(id, n, width, height, source);
        ...
        var result = new SKImagePyramidDziCollectionSource(maxLevel, tileSize, format, items)
        {
