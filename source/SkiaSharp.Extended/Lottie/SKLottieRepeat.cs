...
public readonly struct SKLottieRepeat : IEquatable<SKLottieRepeat>
{
	...
	/// </summary>
	/// <param name="count">Number of additional forward/back cycles after the first. Use -1 for infinite.</param>
	...
	/// <summary>
	/// Gets the number of additional forward/back cycles after the first for reverse repetition,
	/// or additional plays for restart repetition. -1 means infinite.
