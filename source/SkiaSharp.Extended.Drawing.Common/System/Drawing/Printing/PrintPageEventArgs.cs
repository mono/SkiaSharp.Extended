...
public partial class PrintPageEventArgs : EventArgs
{
	...
	/// <param name="graphics">The <see cref="Drawing.Graphics"/> used to paint the page.</param>
	...
	/// <summary>Gets the <see cref="Drawing.Graphics"/> used to paint the page.</summary>
