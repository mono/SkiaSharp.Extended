...
public sealed partial class Encoder
{
	...
	public static readonly Encoder ChrominanceTable = new Encoder(new Guid("f2e455dc-09b3-4316-8260-676ada32481c"));
	...
	public static readonly Encoder ColorSpace = new Encoder(new Guid("ae7a62a0-ee2c-49d8-9d07-1ba8a927596e"));
	...
	public static readonly Encoder ImageItems = new Encoder(new Guid("63875e13-1f1d-45ab-9195-a29b6066a650"));
	/// <summary>An <see cref="Encoder"/> object that is initialized with the GUID for the luminance table parameter category.</summary>
	public static readonly Encoder LuminanceTable = new Encoder(new Guid("edb33bce-0266-4a77-b904-27216099e717"));
	...
	public static readonly Encoder RenderMethod = new Encoder(new Guid("6d42c53a-229a-4825-8bb7-5c99e2b9a8b8"));
	/// <summary>An <see cref="Encoder"/> object that is initialized with the GUID for the save as CMYK parameter category.</summary>
	public static readonly Encoder SaveAsCmyk = new Encoder(new Guid("a219bbc9-0a9d-4f3f-bef2-2cbb5c5f9f1b"));
	...
	public static readonly Encoder ScanMethod = new Encoder(new Guid("3a4e2661-3109-4e56-8536-42c156e7dcfa"));
	/// <summary>An <see cref="Encoder"/> object that is initialized with the GUID for the transformation parameter category.</summary>
	public static readonly Encoder Transformation = new Encoder(new Guid("8d0eb2d1-a58e-4ea8-aa14-108074b7b6f9"));
	/// <summary>An <see cref="Encoder"/> object that is initialized with the GUID for the version parameter category.</summary>
	public static readonly Encoder Version = new Encoder(new Guid("24d18c76-814a-41a4-bf53-1c219cccf797"));
