...
namespace System.Drawing.Drawing2D
{
	...
	public sealed partial class GraphicsPath : System.MarshalByRefObject, System.ICloneable, System.IDisposable
	{
		...
		/// </summary>
		public void Warp(PointF[] destPoints, RectangleF srcRect) { throw new PlatformNotSupportedException("Warp is not yet implemented in SkiaSharp.Extended.Drawing.Common"); }

		/// <summary>
		///  Applies a warp transform to this <see cref="GraphicsPath"/>. Not yet implemented.
		/// </summary>
		public void Warp(PointF[] destPoints, RectangleF srcRect, Matrix? matrix) { throw new PlatformNotSupportedException("Warp is not yet implemented in SkiaSharp.Extended.Drawing.Common"); }

		/// <summary>
		///  Applies a warp transform to this <see cref="GraphicsPath"/>. Not yet implemented.
		/// </summary>
		public void Warp(PointF[] destPoints, RectangleF srcRect, Matrix? matrix, WarpMode warpMode) { throw new PlatformNotSupportedException("Warp is not yet implemented in SkiaSharp.Extended.Drawing.Common"); }

		/// <summary>
		///  Applies a warp transform to this <see cref="GraphicsPath"/>. Not yet implemented.
		/// </summary>
		public void Warp(PointF[] destPoints, RectangleF srcRect, Matrix? matrix, WarpMode warpMode, float flatness) { throw new PlatformNotSupportedException("Warp is not yet implemented in SkiaSharp.Extended.Drawing.Common"); }
