...
namespace System.Drawing
{
	...
	public sealed partial class Region : System.MarshalByRefObject, System.IDisposable
	{
		...
		{
			throw new PlatformNotSupportedException("Region construction from RegionData is not supported in SkiaSharp.Drawing.");
		}
		...
		{
			throw new PlatformNotSupportedException("GDI region handles are not supported in SkiaSharp.Drawing.");
		}
		...
		{
			throw new PlatformNotSupportedException("GetRegionData is not supported in SkiaSharp.Drawing.");
		}
		...
		{
			throw new PlatformNotSupportedException("GetRegionScans is not supported in SkiaSharp.Drawing.");
		}
