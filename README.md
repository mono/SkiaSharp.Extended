...
| [eng/pipelines/package.yml](eng/pipelines/package.yml) | Build and pack only the shipping libraries, sign, register assets in BAR, and promote through Maestro | Windows |
| [eng/pipelines/tests.yml](eng/pipelines/tests.yml) | Build the full solution, including samples, and run tests; no packaging or promotion | Windows, macOS, Linux |
...
`eng/pipelines/package.yml` still declares the `1ESPipelineTemplates` repository
