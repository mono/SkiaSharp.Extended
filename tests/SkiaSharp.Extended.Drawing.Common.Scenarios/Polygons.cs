...
{
    [Fact] public void Polygon_Triangle_Stroke() => Render(100, 100, g => {
    ...
    [Fact] public void Polygon_Triangle_Fill() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Square_Fill() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Pentagon_Fill() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Star_Stroke() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Diamond_StrokeAndFill() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.None;
        g.Clear(Color.White);
