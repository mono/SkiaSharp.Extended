...
{
    [Fact] public void Polygon_Triangle_Stroke_AA() => Render(100, 100, g => {
    ...
    [Fact] public void Polygon_Triangle_Fill_AA() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Square_Fill_AA() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Pentagon_Fill_AA() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Star_Stroke_AA() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.Clear(Color.White);
    ...
    [Fact] public void Polygon_Diamond_StrokeAndFill_AA() => Render(100, 100, g => {
        g.SmoothingMode = SmoothingMode.AntiAlias;
        g.Clear(Color.White);
