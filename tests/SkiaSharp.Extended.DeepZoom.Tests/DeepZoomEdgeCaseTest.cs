...
public class DeepZoomEdgeCaseTest
{
    ...
    public void TileCache_SingleCapacity()
    {
        ...
        cache.Put(a, new SKDeepZoomImageTile(SKImage.FromBitmap(bmp1)));
        Assert.True(cache.TryGet(a, out _));

        cache.Put(b, new SKDeepZoomImageTile(SKImage.FromBitmap(bmp2)));
    ...
    public void TileCache_LRU_EvictsOldest()
    {
        ...
        cache.Put(a, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(10, 10))));
        cache.Put(b, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(10, 10))));
        cache.Put(c, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(10, 10))));

        cache.TryGet(a, out _); // Touch "a"

        cache.Put(d, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(10, 10)))); // Evicts "b"
