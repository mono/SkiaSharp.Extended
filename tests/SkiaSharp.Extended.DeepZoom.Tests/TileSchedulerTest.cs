...
<Image xmlns=""http://schemas.microsoft.com/deepzoom/2008""
  ...
  <Size Width=""4096"" Height=""4096""/>
    ...
    public void FindBestFallback_ReturnsCachedParent()
    {
        ...
        cache.Put(parentId, new SKDeepZoomImageTile(SKImage.FromBitmap(bitmap)));
    ...
    public void FindBestFallback_ReturnsClosestParent()
    {
        ...
        cache.Put(level2, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(256, 256))));
        cache.Put(level4, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(256, 256))));
...
<Image xmlns=""http://schemas.microsoft.com/deepzoom/2008""
  ...
  <Size Width=""16"" Height=""16""/>
    ...
    public void FindBestFallback_MinLevel_RespectsMinimum()
    {
        ...
        cache.Put(level1, new SKDeepZoomImageTile(SKImage.Create(new SKImageInfo(256, 256))));
