...
public class ViewportTest
{
    ...
    {
        var vp = new SKImagePyramidViewport { ControlWidth = 800, ViewportWidth = 1.0 };
    ...
    {
        var vp = new SKImagePyramidViewport { ViewportWidth = 0.001 };
        // Zoom in by 1 billion — should clamp to MinViewportWidth
        vp.ZoomAboutLogicalPoint(1_000_000_000, 0.5, 0.5);
        Assert.True(vp.ViewportWidth >= SKImagePyramidViewport.MinViewportWidth);
    ...
    {
        var vp = new SKImagePyramidViewport { ViewportWidth = SKImagePyramidViewport.MinViewportWidth };
        ...
        Assert.Equal(SKImagePyramidViewport.MinViewportWidth, vp.ViewportWidth);
    ...
    {
        var vp = new SKImagePyramidViewport { ViewportWidth = 0.5 };
    ...
    {
        var a = new SKImagePyramidViewportState(1.0, 0.5, 0.25);
        var b = new SKImagePyramidViewportState(1.0, 0.5, 0.25);
        var c = new SKImagePyramidViewportState(0.5, 0.5, 0.25);
    ...
    {
        var vp = new SKImagePyramidViewport { AspectRatio = 1.5 };
        vp.ControlWidth = 800;
