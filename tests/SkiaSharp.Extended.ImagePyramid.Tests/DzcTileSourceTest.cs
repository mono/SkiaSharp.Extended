...
<Collection MaxLevel=""7"" TileSize=""256"" Format=""jpg"" xmlns=""http://schemas.microsoft.com/deepzoom/2008"">
    ...
    {
        // Morton index 0 → (0,0)
        Assert.Equal((0, 0), SKImagePyramidDziCollectionSource.MortonToGrid(0));
        // Morton index 1 → (1,0)
        Assert.Equal((1, 0), SKImagePyramidDziCollectionSource.MortonToGrid(1));
        // Morton index 2 → (0,1)
        Assert.Equal((0, 1), SKImagePyramidDziCollectionSource.MortonToGrid(2));
        // Morton index 3 → (1,1)
        Assert.Equal((1, 1), SKImagePyramidDziCollectionSource.MortonToGrid(3));
        // Morton index 4 → (2,0)
        Assert.Equal((2, 0), SKImagePyramidDziCollectionSource.MortonToGrid(4));
    }
    ...
    public void GridToMorton_RoundTrips()
    {
        for (int i = 0; i < 100; i++)
        {
            ...
            int morton = SKImagePyramidDziCollectionSource.GridToMorton(col, row);
    ...
    {
        var dzc = new SKImagePyramidDziCollectionSource(8, 256, "jpg", Array.Empty<SKImagePyramidDziCollectionSubImage>());
    ...
    public void Parse_MissingCollection_ThrowsFormatException()
    {
        ...
        Assert.Throws<FormatException>(() => SKImagePyramidDziCollectionSource.Parse(xml));
    }
    ...
    {
        var subImage = new SKImagePyramidDziCollectionSubImage(0, 0, 800, 600, null);
    ...
    {
        var subImage = new SKImagePyramidDziCollectionSubImage(0, 0, 100, 0, null);
    ...
    {
        // Index 5 → col=3, row=0
        Assert.Equal((3, 0), SKImagePyramidDziCollectionSource.MortonToGrid(5));
        // Index 6 → col=2, row=1
        Assert.Equal((2, 1), SKImagePyramidDziCollectionSource.MortonToGrid(6));
        // Index 7 → col=3, row=1
        Assert.Equal((3, 1), SKImagePyramidDziCollectionSource.MortonToGrid(7));
    }

    [Fact]
    public void GetCompositeTileUrl_DifferentLevelsAndPositions()
    {
        var dzc = new SKImagePyramidDziCollectionSource(8, 256, "png", Array.Empty<SKImagePyramidDziCollectionSubImage>());
    ...
    <Items>
        ...
        var dzc = SKImagePyramidDziCollectionSource.Parse(stream, "http://example.com/collection.dzc");
    ...
    {
        var subImage = new SKImagePyramidDziCollectionSubImage(0, 0, 1920, 1080, "test.dzi");
    ...
    {
        var subImage = new SKImagePyramidDziCollectionSubImage(0, 0, 100, 100, null);
    ...
    {
        Assert.Equal(0, SKImagePyramidDziCollectionSource.GridToMorton(0, 0));
        Assert.Equal(1, SKImagePyramidDziCollectionSource.GridToMorton(1, 0));
        Assert.Equal(2, SKImagePyramidDziCollectionSource.GridToMorton(0, 1));
        Assert.Equal(3, SKImagePyramidDziCollectionSource.GridToMorton(1, 1));
        Assert.Equal(4, SKImagePyramidDziCollectionSource.GridToMorton(2, 0));
        Assert.Equal(5, SKImagePyramidDziCollectionSource.GridToMorton(3, 0));
    }
    ...
    {
        var jpgDzc = new SKImagePyramidDziCollectionSource(8, 256, "jpg", Array.Empty<SKImagePyramidDziCollectionSubImage>());
        var pngDzc = new SKImagePyramidDziCollectionSource(8, 256, "png", Array.Empty<SKImagePyramidDziCollectionSubImage>());
    ...
    public void Constructor_InvalidTileSize_Throws()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new SKImagePyramidDziCollectionSource(8, 0, "jpg", Array.Empty<SKImagePyramidDziCollectionSubImage>()));
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new SKImagePyramidDziCollectionSource(8, -1, "jpg", Array.Empty<SKImagePyramidDziCollectionSubImage>()));
    }
    ...
    public void Constructor_EmptyFormat_Throws()
    {
        Assert.Throws<ArgumentException>(() =>
            new SKImagePyramidDziCollectionSource(8, 256, "", Array.Empty<SKImagePyramidDziCollectionSubImage>()));
    }

    [Fact]
    public void SubImage_ViewportProperties_SetAndGet()
    {
        var sub = new SKImagePyramidDziCollectionSubImage(0, 0, 100, 100, null);
    ...
    public void MortonToGrid_LargeIndices()
    {
        ...
        Assert.Equal((0, 2), SKImagePyramidDziCollectionSource.MortonToGrid(8));
        Assert.Equal((1, 2), SKImagePyramidDziCollectionSource.MortonToGrid(9));
        Assert.Equal((0, 3), SKImagePyramidDziCollectionSource.MortonToGrid(10));
        Assert.Equal((3, 3), SKImagePyramidDziCollectionSource.MortonToGrid(15));
    }
    ...
    public void MortonToGrid_PowerOfFourIndices()
    {
        ...
        var (c16, r16) = SKImagePyramidDziCollectionSource.MortonToGrid(16);
        Assert.Equal(4, c16);
        Assert.Equal(0, r16);
    }
