...
/// <summary>
/// Tests for low-coverage areas: SKImagePyramidViewportState, SKImagePyramidTileRequest, viewport, and controller.
/// </summary>
public class CoverageGapTest
{
    ...
    {
        var state = new SKImagePyramidViewportState(0.5, 0.1, 0.2);
    ...
    {
        var s1 = new SKImagePyramidViewportState(0.5, 0.1, 0.2);
        var s2 = new SKImagePyramidViewportState(0.5, 0.1, 0.2);
        var s3 = new SKImagePyramidViewportState(0.3, 0.1, 0.2);
    ...
    public void ViewportState_Equals_Object()
    {
        ...
        Assert.True(s1.Equals((object)new SKImagePyramidViewportState(0.5, 0.1, 0.2)));
    }
    ...
    [Fact]
    public void ImagePyramidController_LoadAndDispose()
    {
    ...
    [Fact]
    public void ImagePyramidController_Dispose_MultipleTimes()
    {
        var xml = TestDataHelper.GetString("sample.dzi");
        var dzi = SKImagePyramidDziSource.Parse(xml);
        var controller = new SKImagePyramidController();
