...
<Image TileSize=""254"" Overlap=""1"" Format=""png"" xmlns=""http://schemas.microsoft.com/deepzoom/2009"">
    ...
    public void Parse_EmbeddedSampleDzi_ParsesCorrectly()
    {
        ...
        var dzi = SKImagePyramidDziSource.Parse(stream);
...
<Image TileSize=""254"" Overlap=""1"" Format=""jpg"" xmlns=""http://schemas.microsoft.com/deepzoom/2008"">
    ...
    public void MaxLevel_CalculatedCorrectly()
    {
        ...
        var dzi = new SKImagePyramidDziSource(7026, 9221, 256, 2, "jpg");
        Assert.Equal(14, dzi.MaxLevel); // ceil(log2(9221)) = ceil(13.17) = 14

        var small = new SKImagePyramidDziSource(240, 160, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(1024, 512, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(200, 100, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(1024, 512, 256, 2, "jpg");
        var bounds = dzi.GetTileBounds(dzi.MaxLevel, 0, 0);
        Assert.Equal(0, bounds.X);
        Assert.Equal(0, bounds.Y);
    ...
    public void Parse_WithBaseUri_SetsTilesBaseUri()
    {
        ...
        var dzi = SKImagePyramidDziSource.Parse(xml, "http://example.com/image_files/");
    ...
    public void Parse_MissingImage_ThrowsFormatException()
    {
        ...
        Assert.Throws<FormatException>(() => SKImagePyramidDziSource.Parse(xml));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new SKImagePyramidDziSource(0, 100, 256, 0, "jpg"));
    }

    [Fact]
    public void Constructor_InvalidTileSize_Throws()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new SKImagePyramidDziSource(100, 100, 0, 0, "jpg"));
    }

    [Fact]
    public void Constructor_NegativeOverlap_Throws()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new SKImagePyramidDziSource(100, 100, 256, -1, "jpg"));
    }

    [Fact]
    public void GetLevelWidth_InvalidLevel_Throws()
    {
        var dzi = new SKImagePyramidDziSource(100, 100, 256, 0, "jpg");
    ...
    public void GetLevelDimensions_NonPowerOfTwo_CeilsCorrectly()
    {
        ...
        var dzi = new SKImagePyramidDziSource(1000, 750, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(1024, 1024, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(4096, 4096, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(2048, 2048, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(2048, 2048, 256, 0, "png");
    ...
    public void EdgeTile_IsClipped()
    {
        ...
        var dzi = new SKImagePyramidDziSource(300, 200, 256, 0, "jpg");
    ...
    public void Parse_MalformedXml_ThrowsException()
    {
        Assert.Throws<System.Xml.XmlException>(() =>
            SKImagePyramidDziSource.Parse("not valid xml"));
    }
...
<Image xmlns='http://schemas.microsoft.com/deepzoom/2008' Format='jpg'>
  <Size Width='1000' Height='800'/>
    ...
    public void Parse_WithBaseUri_RoundTrips()
    {
        ...
        var dzi = SKImagePyramidDziSource.Parse(xml, "http://example.com/tiles/");
    ...
    public void GetTileBounds_WithOverlap1_EdgeAndNonEdgeTiles()
    {
        ...
        var dzi = new SKImagePyramidDziSource(1024, 512, 256, 1, "jpg");
        int maxLevel = dzi.MaxLevel;
    ...
    public void Parse_WithBaseUri_TileUrlsIncorporateBaseUri()
    {
        ...
        var dzi = SKImagePyramidDziSource.Parse(xml, "https://cdn.example.com/myimage_files/");
    ...
    public void Parse_StreamWithBaseUri_SetsTilesBaseUri()
    {
        ...
        using var stream = new MemoryStream(System.Text.Encoding.UTF8.GetBytes(xml));
        var dzi = SKImagePyramidDziSource.Parse(stream, "file:///images/photo_files/");
    ...
    {
        var dzi = new SKImagePyramidDziSource(4096, 2048, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(999, 501, 256, 0, "jpg");
    ...
    {
        var dzi = new SKImagePyramidDziSource(3, 5, 256, 0, "jpg");
        Assert.Equal(1, dzi.GetLevelWidth(0));
        Assert.Equal(1, dzi.GetLevelHeight(0));
    }
...
<Image TileSize=""256"" Overlap=""0"" Format=""png"" xmlns=""http://schemas.microsoft.com/deepzoom/2009"">
    ...
    {
        var rect = new SKImagePyramidDisplayRect(0, 0, 100, 100, 3, 8);
    ...
    {
        var a = new SKImagePyramidDisplayRect(10, 20, 100, 200, 3, 8);
        var b = new SKImagePyramidDisplayRect(10, 20, 100, 200, 3, 8);
        var c = new SKImagePyramidDisplayRect(10, 20, 100, 200, 4, 8);
    ...
    {
        var rect = new SKImagePyramidDisplayRect(10, 20, 300, 400, 3, 8);
        Assert.Equal("SKImagePyramidDisplayRect(10, 20, 300x400, Levels 3-8)", rect.ToString());
    }

    [Fact]
    public void Constructor_DefaultDisplayRects_IsEmpty()
    {
        var dzi = new SKImagePyramidDziSource(1024, 768, 256, 1, "jpg");
        Assert.Empty(dzi.DisplayRects);
    }
}
