...
public class ImagePyramidSubImageTest
{
    [Fact]
    public void Constructor_SetsProperties()
    {
        var sub = new SKImagePyramidSubImage(42, 7, 1.5, "http://example.com/42.dzi");
    ...
    {
        var sub = new SKImagePyramidSubImage(0, 0, 2.0, null); // Width is 2x height
    ...
    {
        var sub = new SKImagePyramidSubImage(0, 0, 1.5, null);
        sub.ViewportWidth = 5;
    ...
    {
        var sub = new SKImagePyramidSubImage(0, 0, 2.0, null); // width:height = 2:1
        sub.ViewportWidth = 10;
        sub.ViewportOriginX = 0;
        sub.ViewportOriginY = 0;
    ...
    {
        var sub = new SKImagePyramidSubImage(1, 0, 2.0, null);
        sub.ViewportWidth = 4;
    ...
    {
        var sub = new SKImagePyramidSubImage(0, 0, 0, null);
