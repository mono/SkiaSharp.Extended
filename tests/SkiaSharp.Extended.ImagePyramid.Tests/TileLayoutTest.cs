...
<Image xmlns=""http://schemas.microsoft.com/deepzoom/2008""
  ...
  <Size Width=""1024"" Height=""768""/>
    ...
    private static SKImagePyramidDziSource CreateLargeDzi()
    {
        string xml = @"<?xml version=""1.0"" encoding=""UTF-8""?>
<Image xmlns=""http://schemas.microsoft.com/deepzoom/2008""
       Format=""jpg"" Overlap=""1"" TileSize=""256"">
  <Size Width=""4096"" Height=""4096""/>
        ...
        return SKImagePyramidDziSource.Parse(xml, "http://example.com/large");
    }
    ...
    public void GetVisibleTiles_FullView_ReturnsCorrectTiles()
    {
        ...
        var viewport = new SKImagePyramidViewport
        {
            ControlWidth = 800,
            ControlHeight = 600,
            ViewportWidth = 1.0,
    ...
    public void GetVisibleTiles_ZoomedIn_ReturnsFewerTiles()
    {
        ...
        var fullViewport = new SKImagePyramidViewport
        {
            ControlWidth = 800,
            ControlHeight = 800,
            ViewportWidth = 1.0,
        ...
        var zoomedViewport = new SKImagePyramidViewport
        {
            ControlWidth = 800,
            ControlHeight = 800,
            ViewportWidth = 0.1,
    ...
    public void GetVisibleTiles_AllTilesAreUnique()
    {
        ...
        var tiles = layout.GetVisibleTiles(dzi, viewport);
        var uniqueIds = new HashSet<SKImagePyramidTileId>(tiles.Select(t => t.TileId));
    ...
    public void FindBestFallback_ReturnsCachedParent()
    {
        ...
        cache.Put(parentId, new SKImagePyramidTile(SKImage.FromBitmap(bitmap)));
    ...
    public void FindBestFallback_ReturnsNull_WhenNoParentCached()
    {
        ...
        var childId = new SKImagePyramidTileId(5, 2, 3);
        var fallback = layout.FindBestFallback(childId, cache);
    ...
    public void FindBestFallback_ReturnsClosestParent()
    {
        ...
        cache.Put(level2, new SKImagePyramidTile(SKImage.Create(new SKImageInfo(256, 256))));
        cache.Put(level4, new SKImagePyramidTile(SKImage.Create(new SKImageInfo(256, 256))));
    ...
    public void GetFallbackSourceRect_CalculatesCorrectSubRegion()
    {
        ...
        var parent = new SKImagePyramidTileId(5, 0, 0);
        var child = new SKImagePyramidTileId(6, 0, 0);
...
<Image xmlns=""http://schemas.microsoft.com/deepzoom/2008""
  ...
  <Size Width=""16"" Height=""16""/>
    ...
    public void FindBestFallback_ReturnsNull_WhenNoParentInCache()
    {
        ...
        var childId = new SKImagePyramidTileId(8, 3, 3);
        var fallback = layout.FindBestFallback(childId, cache);
    ...
    public void GetFallbackSourceRect_ReturnsCorrectSubrect()
    {
        ...
        var parent = new SKImagePyramidTileId(8, 0, 0);
        var child = new SKImagePyramidTileId(9, 1, 1);
    ...
    public void FindBestFallback_MinLevel_RespectsMinimum()
    {
        ...
        cache.Put(level1, new SKImagePyramidTile(SKImage.Create(new SKImageInfo(256, 256))));
    ...
    public void FindBestFallback_Level0Requested_ReturnsNull()
    {
        ...
        var tileId = new SKImagePyramidTileId(0, 0, 0);
    ...
    public void GetFallbackSourceRect_TwoLevelDiff_QuarterSize()
    {
        ...
        var parent = new SKImagePyramidTileId(7, 0, 0);
        var child = new SKImagePyramidTileId(9, 0, 0); // 2 levels deeper, same position
    ...
    public void GetFallbackSourceRect_ChildInBottomRightQuadrant_HasPositiveOffset()
    {
        ...
        var parent = new SKImagePyramidTileId(8, 0, 0);
        var child = new SKImagePyramidTileId(9, 1, 1); // bottom-right quadrant of parent (0,0)
